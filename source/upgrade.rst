...
leave this field when submitting updates (additions) of ROA
configurations, but you will see this field in response. The value will
be `null` in case a ROA configuration has no comment.
