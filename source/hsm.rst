...
application that is using the key. The use of HSMs is supported in
Krill 0.10.0-rc1 and up.
...
Configuring your Signers
------------------------

HSM support is enabled by default, but in order to use your HSM you will
have to do some vendor specific set up of the HSM itself which we cannot
document here. Then you will need to configure Krill to use your HSM,
either by using PKCS#11 or KMIP.
